...
const ResumeAnalysis = () => {
  ...
  const handleGetAdvice = () => {
    navigate("/career-counseling", { state: { analysisResult } });
  };
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            ...
            content, formatting, and skill gaps to stand out from the crowd.
          </p>
        </div>
            ...
            {analysisResult ? (
              <Card className="shadow-card bg-gradient-card border-border/50">
                <CardHeader>
                  ...
                  <CardDescription>
                    Here is a detailed breakdown of your resume based on our
                    AI's assessment.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {Object.entries(analysisResult.feedback).map(
                      ([key, value]: [string, any]) => (
                        <div
                          key={key}
                          className="flex items-start space-x-3 p-4 rounded-lg border bg-background"
                        >
                          <div
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Based on current industry trends, consider developing
                      these skills to be more competitive.
                    </p>
                    <div className="flex flex-wrap gap-2">
                      {analysisResult.skill_gaps.map((skill: string) => (
                        <Badge
                          key={skill}
                          variant="outline"
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Button className="w-full" onClick={handleGetAdvice}>
